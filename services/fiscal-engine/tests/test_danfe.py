...
def test_builds_danfe_from_normalized_xml_document(tmp_path):
    ...
    document = {
        ...
        "direction": "saida",
        "issuer_tax_id": "1" * 14,
        "recipient_tax_id": "2" * 14,
        "total_value": "117500.00",
        "normalized": {
            "nature": "VENDA DE MERCADORIA",
            "issuer": {"name": "Emitente Ltda.", "tax_id": "1" * 14, "address": {"street": "Rua A", "number": "10", "city": "Salvador", "state": "BA"}},
            "recipient": {"name": "Cliente Auditável", "tax_id": "2" * 14, "address": {"street": "Rua B", "number": "20", "city": "Salvador", "state": "BA"}},
