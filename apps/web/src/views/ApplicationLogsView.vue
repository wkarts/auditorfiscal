...
<template>
  <section class="card">
    <div class="card-title"><div><h2>Logs da aplicação</h2><p>Eventos técnicos persistidos, pesquisáveis e vinculados às auditorias.</p></div><button @click="load(meta?.current_page||1)">Atualizar</button></div>
    ...
    <table>
      <thead><tr><th>Data</th><th>Nível</th><th>Componente</th><th>Evento</th><th>Mensagem</th><th>Auditoria</th><th>Incidente</th></tr></thead>
