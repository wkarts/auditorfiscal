...
Consulte `docker compose logs -f auditor-fiscal-worker auditor-fiscal-fiscal-engine auditor-fiscal-api`. Lotes com falha preservam o erro e os arquivos originais. Após corrigir infraestrutura ou fonte, reexecute o lote.
